...
type Backend interface {
	...
	AccountsList(ctx context.Context, query storage.ListAccountsQuery) (*paginate.Cursor[models.Account], error)
	AccountsGet(ctx context.Context, id models.AccountID) (*models.Account, error)

	// Balances
	BalancesList(ctx context.Context, query storage.ListBalancesQuery) (*paginate.Cursor[models.Balance], error)
	...
	BankAccountsList(ctx context.Context, query storage.ListBankAccountsQuery) (*paginate.Cursor[models.BankAccount], error)
	...
	PaymentsList(ctx context.Context, query storage.ListPaymentsQuery) (*paginate.Cursor[models.Payment], error)
	...
	PaymentInitiationsList(ctx context.Context, query storage.ListPaymentInitiationsQuery) (*paginate.Cursor[models.PaymentInitiation], error)
	...
	PaymentInitiationAdjustmentsList(ctx context.Context, id models.PaymentInitiationID, query storage.ListPaymentInitiationAdjustmentsQuery) (*paginate.Cursor[models.PaymentInitiationAdjustment], error)
	...
	PaymentInitiationRelatedPaymentsList(ctx context.Context, id models.PaymentInitiationID, query storage.ListPaymentInitiationRelatedPaymentsQuery) (*paginate.Cursor[models.Payment], error)
	...
	PaymentServiceUsersList(ctx context.Context, query storage.ListPSUsQuery) (*paginate.Cursor[models.PaymentServiceUser], error)
	...
	PaymentServiceUsersConnectionsList(ctx context.Context, psuID uuid.UUID, connectorID *models.ConnectorID, query storage.ListOpenBankingConnectionsQuery) (*paginate.Cursor[models.OpenBankingConnection], error)
	...
	PaymentServiceUsersLinkAttemptsList(ctx context.Context, psuID uuid.UUID, connectorID models.ConnectorID, query storage.ListOpenBankingConnectionAttemptsQuery) (*paginate.Cursor[models.OpenBankingConnectionAttempt], error)
	PaymentServiceUsersLinkAttemptsGet(ctx context.Context, psuID uuid.UUID, connectorID models.ConnectorID, id uuid.UUID) (*models.OpenBankingConnectionAttempt, error)
	...
	PoolsList(ctx context.Context, query storage.ListPoolsQuery) (*paginate.Cursor[models.Pool], error)
	...
	// Schedules
	SchedulesList(ctx context.Context, query storage.ListSchedulesQuery) (*paginate.Cursor[models.Schedule], error)
	...
	// Workflows Instances
	WorkflowsInstancesList(ctx context.Context, query storage.ListInstancesQuery) (*paginate.Cursor[models.Instance], error)

	// Orders
	OrdersList(ctx context.Context, query storage.ListOrdersQuery) (*paginate.Cursor[models.Order], error)
	OrdersGet(ctx context.Context, id models.OrderID) (*models.Order, error)

	// Conversions
	ConversionsList(ctx context.Context, query storage.ListConversionsQuery) (*paginate.Cursor[models.Conversion], error)
