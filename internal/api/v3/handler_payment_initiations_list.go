...
func paymentInitiationsList(backend backend.Backend) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		query, err := paginate.Extract[storage.ListPaymentInitiationsQuery](r, func() (*storage.ListPaymentInitiationsQuery, error) {
		...
		api.RenderCursor(w, paginate.Cursor[models.PaymentInitiationExpanded]{
