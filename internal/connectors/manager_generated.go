...
func (m *MockManager) Load(arg0 models.Connector, arg1, arg2 bool) (string, json.RawMessage, error) {
	m.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) Load(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Load", reflect.TypeOf((*MockManager)(nil).Load), arg0, arg1, arg2)
}
