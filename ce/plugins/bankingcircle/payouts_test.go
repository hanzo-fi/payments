			...
			samplePSPPaymentInitiation = models.PSPPaymentInitiation{
				...
				DestinationAccount: &models.PSPAccount{
					...
					Metadata: map[string]string{
						models.AccountIBANMetadataKey:               "iban",
						models.AccountAccountNumberMetadataKey:      "acc",
						models.AccountSwiftBicCodeMetadataKey:       "bic",
						models.AccountBankAccountCountryMetadataKey: "US",
					},
				},
