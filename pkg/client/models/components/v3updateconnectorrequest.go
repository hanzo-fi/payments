...
const (
	...
	V3UpdateConnectorRequestTypeBankingbridge V3UpdateConnectorRequestType = "Bankingbridge"
...
func CreateV3UpdateConnectorRequestBankingbridge(bankingbridge V3BankingbridgeConfig) V3UpdateConnectorRequest {
	typ := V3UpdateConnectorRequestTypeBankingbridge
...
func CreateV3UpdateConnectorRequestCoinbaseprime(coinbaseprime V3CoinbaseprimeConfig) V3UpdateConnectorRequest {
	typ := V3UpdateConnectorRequestTypeCoinbaseprime
...
func CreateV3UpdateConnectorRequestFireblocks(fireblocks V3FireblocksConfig) V3UpdateConnectorRequest {
	typ := V3UpdateConnectorRequestTypeFireblocks
...
func CreateV3UpdateConnectorRequestIncrease(increase V3IncreaseConfig) V3UpdateConnectorRequest {
	typ := V3UpdateConnectorRequestTypeIncrease
...
func (u *V3UpdateConnectorRequest) UnmarshalJSON(data []byte) error {
	...
	case "Bankingbridge":
		...
		if err := utils.UnmarshalJSON(data, &v3BankingbridgeConfig, "", true, false); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Provider == Bankingbridge) type V3BankingbridgeConfig within V3UpdateConnectorRequest: %w", string(data), err)
		}

		u.V3BankingbridgeConfig = v3BankingbridgeConfig
		u.Type = V3UpdateConnectorRequestTypeBankingbridge
		return nil
	case "Bankingcircle":
	...
	case "Coinbaseprime":
		...
		if err := utils.UnmarshalJSON(data, &v3CoinbaseprimeConfig, "", true, false); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Provider == Coinbaseprime) type V3CoinbaseprimeConfig within V3UpdateConnectorRequest: %w", string(data), err)
		}

		u.V3CoinbaseprimeConfig = v3CoinbaseprimeConfig
		u.Type = V3UpdateConnectorRequestTypeCoinbaseprime
		return nil
	case "Column":
	...
	case "Fireblocks":
		...
		if err := utils.UnmarshalJSON(data, &v3FireblocksConfig, "", true, false); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Provider == Fireblocks) type V3FireblocksConfig within V3UpdateConnectorRequest: %w", string(data), err)
		}

		u.V3FireblocksConfig = v3FireblocksConfig
		u.Type = V3UpdateConnectorRequestTypeFireblocks
		return nil
	case "Generic":
	...
	case "Increase":
		...
		if err := utils.UnmarshalJSON(data, &v3IncreaseConfig, "", true, false); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Provider == Increase) type V3IncreaseConfig within V3UpdateConnectorRequest: %w", string(data), err)
		}
