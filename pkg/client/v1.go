...
func (s *V1) UpdatePoolQuery(ctx context.Context, poolID string, updatePoolQueryRequest components.UpdatePoolQueryRequest, opts ...operations.Option) (*operations.UpdatePoolQueryResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/pools/{poolId}/query", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
